...
Es ist ein Kassakonto ohne Fremdkapital. Gekauft wird höchstens für das
vorhandene Bargeld, verkauft höchstens die vorhandene Position. Damit kann die
Simulation nichts darstellen, was ein Konto ohne Margin-Freigabe gar nicht tun
könnte.
"""
